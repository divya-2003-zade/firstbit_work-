...
class Car extends Vehicle{
	...
	public String toString() {
		return super.toString()+"\nHas Power Steering : " + this.hasPowerSteering+"\nDrive Mode : "
	+ this.driveMode+"\nParking Assist Sensors : " + this.parkingAssistSensors;
	}
}
...
class TestVehicle {
	...
	public static void main(String[] args) {
        ...
        v= new Bike("MH31CD5678","Activa 6G","Honda", 2,85000, 1,2, "Scooter");
        System.out.println(v.toString());        v.brake();
        System.out.println();

        System.out.println("Car Details");
        v = new Car("MH12EF1234","Creta","Hyundai",4,1200000,true,"Automatic",4);
        System.out.println(v.toString());
        v.brake();
        System.out.println();

        System.out.println("Bus Details");
        v= new Bus("MH40GH5678","Starbus","Tata",6,2500000,50,20);
        System.out.println(v.toString());
        v.brake();
